...
function ProtectedRoute({ children, roles }) {
  ...
  if (loading) return <div className="min-h-screen flex items-center justify-center text-slate-400"><div className="text-center"><div className="w-10 h-10 border-2 border-yellow-500/30 border-t-yellow-500 rounded-full animate-spin mx-auto mb-3"></div>Verifying secure session...</div></div>;
...
export default function App() {
  return <div className="App"><ThemeProvider><LanguageProvider><AuthProvider><AppRoutes/><Toaster position="top-center" theme="dark" richColors closeButton/></AuthProvider></LanguageProvider></ThemeProvider></div>;
}
